...
function App() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* 第21条（本契約の有効期間） */}
      <div style={sectionStyle}>第21条（本契約の有効期間）</div>
      <p>
      ...
      {/* 第22条（本規約の変更） */}
      <div style={sectionStyle}>第22条（本規約の変更）</div>
      <ol>
        <li>
      ...
      {/* 第23条（準拠法） */}
      <div style={sectionStyle}>第23条（準拠法）</div>
      <p>本規約に関する準拠法は、全て日本国の法令が適用されます。</p>
      {/* 第24条（合意管轄） */}
      <div style={sectionStyle}>第24条（合意管轄）</div>
      <p>
        ユーザーと当社との間における一切の訴訟は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。
      </p>
      {/* 第25条（その他） */}
      <div style={sectionStyle}>第25条（その他）</div>
      <ol>
        <li>
