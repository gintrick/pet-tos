...
function App() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* 第一条（目的） */}
      <div style={sectionStyle}>第一条（目的）</div>
      <ol>
        <li>
          この利用規約（以下「本規約」といいます。）は、株式会社GinTrick（以下「当社」といいます。）が運営するスマートフォン用サービスであるアプリケーション「ペットの気持ちAI」（以下「本サービス」といいます。）を利用するユーザー（以下「ユーザー」といいます。）に適用されます。ユーザーは、本規約に同意の上、本サービスを利用します。
        </li>
        <li>
          本規約は、本サービスの利用条件を定めています。本サービスにユーザー登録したユーザーは全て本規約に従い、年齢や利用環境等の条件に応じて、本規約の定める条件に従って本サービスを利用します。
        </li>
        <li>
          ユーザーが本規約に同意することにより、当社との間に本契約（第二条で定義します。）が成立します。なお、未成年者が当社との間で本契約を締結するにあたっては、法定代理人（親権者又は未成年後見人）の事前の同意を得るものとします。
        </li>
      </ol>

      {/* 第二条（定義） */}
      <div style={sectionStyle}>第二条（定義）</div>
      <ol>
        <li>
      ...
      {/* 第三条（ユーザー登録） */}
      <div style={sectionStyle}>第三条（ユーザー登録）</div>
      <ol>
        <li>
      ...
      {/* 第四条（本サービスの内容） */}
      <div style={sectionStyle}>第四条（本サービスの内容）</div>
      <p>
        本サービスは、AI(ChatGPT)を使って動物の気持ちを読み解き、吹き出し形式で表示を行うなどが可能なスマートフォン用アプリケーションサービスです。詳細な機能は別途当社が定めるウェブページ等において随時更新します。
      </p>

      {/* 第五条（利用料金） */}
      <div style={sectionStyle}>第五条（利用料金）</div>
      <ol>
        <li>
        ...
        <li>
          LLCが定めるGoogle Playにおける支払方法若しくは又はApple
          Inc.が定めるApp
          Storeにおける支払方法又はストライプジャパン株式会社が提供する決済システム「Stripe」など別途当社が指定する決済サービスにてお支払いいただくものとします。
        </li>
        <li>
          前項に定める申込みの完了後、Google Play又はApp
          storeにおける決済が完了したことを示す画面が表示された時点で、当該有料コンテンツの購入に係る契約がユーザーと当社との間に成立し、その効力を生じるとともに、当該契約に係る決済が完了します。ユーザーは、当該契約の成立後に、有料コンテンツの購入をキャンセルすることができないことを、あらかじめ了承するものとします。
        </li>
        <li>
      ...
      {/* 第七条（本サービスの提供条件） */}
      <div style={sectionStyle}>第七条（本サービスの提供条件）</div>
      <p>
        当社は、メンテナンス等のために、ユーザーに通知することなく、本サービスを停止又は変更することがあります。
      </p>

      {/* 第八条（知的財産権等） */}
      <div style={sectionStyle}>第八条（知的財産権等）</div>
      <ol>
        <li>
      ...
      {/* 第九条（禁止事項） */}
      <div style={sectionStyle}>第九条（禁止事項）</div>
      <p>
      ...
      {/* 第十条（解除） */}
      <div style={sectionStyle}>第十条（解除）</div>
      <ol>
        <li>
      ...
      {/* 第十一条（非保証・免責） */}
      <div style={sectionStyle}>第十一条（非保証・免責）</div>
      <ol>
        <li>
        ...
        <li>
          ユーザーが本サービス上においてアップロードした画像は、吹き出し形式で動物の気持ちが表示された後、最大3日間サーバーに保存されます。この期間経過後、画像は自動的に永久に削除され、削除された画像は復元できません。当社は、ユーザーが当該削除により損害を被った場合でも、一切責任を負いません。
        </li>
        <li>
          ユーザーが本サービスを利用するにあたり、本サービスから本サービスに関わる第三者が運営する他のサービス（OpenAI,
      ...
      {/* 第十二条（損害賠償責任） */}
      <div style={sectionStyle}>第十二条（損害賠償責任）</div>
      <ol>
        <li>
      ...
      {/* 第十三条（本サービスの廃止） */}
      <div style={sectionStyle}>第十三条（本サービスの廃止）</div>
      <ol>
        <li>
      ...
      {/* 第十四条（秘密保持） */}
      <div style={sectionStyle}>第十四条（秘密保持）</div>
      <ol>
        <li>
      ...
      {/* 第十五条（反社会的勢力の排除） */}
      <div style={sectionStyle}>第十五条（反社会的勢力の排除）</div>
      <ol>
        <li>
        ...
        <li>
          ...
          <ol>
            <li>暴力的な要求行為 法的な責任を超えた不当な要求行為</li>
      ...
      {/* 第十六条（お問い合わせ対応） */}
      <div style={sectionStyle}>第十六条（お問い合わせ対応）</div>
      <ol>
        <li>
      ...
      {/* 第十七条（地位の譲渡等） */}
      <div style={sectionStyle}>第十七条（地位の譲渡等）</div>
      <p>
      ...
      {/* 第十八条（個人情報の取り扱い） */}
      <div style={sectionStyle}>第十八条（個人情報の取り扱い）</div>
      <p>
        本サービスにおける個人情報の取り扱いに関しては、当社が定める「プライバシーポリシー」に基づき取り扱います。
      </p>

      {/* 第十九条（分離可能性） */}
      <div style={sectionStyle}>第十九条（分離可能性）</div>
      <ol>
        <li>
      ...
      {/* 第二十条（違反行為への対処方法） */}
      <div style={sectionStyle}>第二十条（違反行為への対処方法）</div>
      <ol>
        <li>
      ...
      {/* 第二十一条（本契約の有効期間） */}
      <div style={sectionStyle}>第二十一条（本契約の有効期間）</div>
      <p>
        本契約の有効期間は、本契約成立時からユーザーが退会するまでの間とします。
      </p>

      {/* 第二十二条（本規約の変更） */}
      <div style={sectionStyle}>第二十二条（本規約の変更）</div>
      <ol>
        <li>
      ...
      {/* 第二十三条（準拠法） */}
      <div style={sectionStyle}>第二十三条（準拠法）</div>
      <p>本規約に関する準拠法は、全て日本国の法令が適用されます。</p>

      {/* 第二十四条（合意管轄） */}
      <div style={sectionStyle}>第二十四条（合意管轄）</div>
      <p>
        ユーザーと当社との間における一切の訴訟は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。
      </p>

      {/* 第二十五条（その他） */}
      <div style={sectionStyle}>第二十五条（その他）</div>
      <ol>
        <li>
